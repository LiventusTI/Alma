...
{
    public class HistoricoComercialController : Controller
    {
        public string nombrename = "";
        public string idid = "";
        public ActionResult HistoricoComercialView()
        {
            ...
            List<Clases.Objeto> lista_clientesnameid = ServicioModels.GetClientsNameId();
            ViewBag.lista_clientesnameid = lista_clientesnameid;
            ...
            //if (nombrename == "" && idid == "")
            //{
            //    serviciosLista = ServicioModels.GetServicios3();
        ...
        public JsonResult ObtenerServiciosFiltrados(List<memberGroup> datos)
        {
            List<Clases.Servicio> serviciosLista = new List<Clases.Servicio>();

            serviciosLista = ServicioModels.GetServiciosHistoricoComercial(datos[0].cliente, datos[0].contenedor);
            var resultados = Json(serviciosLista, JsonRequestBehavior.AllowGet);
