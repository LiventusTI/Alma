...
{
    public class TransitoEnCursoComercialController : Controller
    {
        public string nombrename = "";
        public string idid = "";
        public ActionResult TransitoEnCursoComercialView()
        {
        ...
        public JsonResult ObtenerServiciosFiltrados(List<memberGroup> datos)
        {
            ...
            serviciosLista = ServicioModels.GetServicios2(datos[0].cliente, datos[0].contenedor);
